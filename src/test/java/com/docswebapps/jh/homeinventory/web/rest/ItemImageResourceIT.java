...
class ItemImageResourceIT {
    ...
    void createItemImage() throws Exception {
        ...
        restItemImageMockMvc
            .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(itemImageDTO)))
        ...
        assertThat(testItemImage.getName()).isEqualTo(DEFAULT_NAME);
        ...
        assertThat(testItemImage.getLastModifiedDate()).isEqualTo(DEFAULT_LAST_MODIFIED_DATE);
    }
    ...
    @Test
    @Transactional
    void putNewItemImage() throws Exception {
        // Initialize the database
        itemImageRepository.saveAndFlush(itemImage);
        ...
        restItemImageMockMvc
            .perform(
                put(ENTITY_API_URL_ID, itemImageDTO.getId())
        ...
        ItemImage testItemImage = itemImageList.get(itemImageList.size() - 1);
        assertThat(testItemImage.getName()).isEqualTo(UPDATED_NAME);
        ...
        assertThat(testItemImage.getLastModifiedDate()).isEqualTo(UPDATED_LAST_MODIFIED_DATE);
    }
    ...
    void putWithMissingIdPathParamItemImage() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restItemImageMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(itemImageDTO)))
    ...
    void partialUpdateItemImageWithPatch() throws Exception {
        ...
        partialUpdatedItemImage.createdDate(UPDATED_CREATED_DATE).lastModifiedDate(UPDATED_LAST_MODIFIED_DATE);
    ...
    void patchNonExistingItemImage() throws Exception {
        ...
        restItemImageMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, itemImageDTO.getId())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(itemImageDTO))
            )
            .andExpect(status().isBadRequest());
    ...
    void patchWithMissingIdPathParamItemImage() throws Exception {
        ...
        restItemImageMockMvc
            .perform(
                patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(TestUtil.convertObjectToJsonBytes(itemImageDTO))
            )
            .andExpect(status().isMethodNotAllowed());
