...
describe('Component Tests', () => {
  describe('ItemOwner Management Component', () => {
    let comp: ItemOwnerComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemOwnerComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemOwners?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
