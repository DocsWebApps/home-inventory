...
describe('Component Tests', () => {
  describe('ItemModel Management Component', () => {
    let comp: ItemModelComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ItemModelComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.itemModels?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
